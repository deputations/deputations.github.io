...
(function () {
  ...
  function buildDisclaimer() {
    ...
    var paras = [
      "I have conceptualised and developed <strong>Deputations Portal</strong> in my personal capacity, as an independent initiative to assist Government officers and officials seeking Central Government deputation opportunities.",
      "My aim is to provide a <strong>holistic, organised, and user-focused</strong> platform for deputation-related vacancies, rules, references, guidance, and supporting tools, so that you can access relevant information with greater ease and clarity.",
