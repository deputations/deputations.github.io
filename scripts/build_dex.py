    ...
    methodology = {
        ...
        "changelog": [
            {"version": "0.1.0-beta", "date": datetime.now(timezone.utc).strftime("%Y-%m-%d"),
             "note": "Initial public beta. Formula derived from one-row-per-org policy snapshots; per-applicant timeline reports begin populating via the community survey."}
        ]
    }
